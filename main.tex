...
\cventry{Nov 2015 -- now}{Backend developer, infrastructure engineer}{\href{codesign.io}{CoDesign.IO (startup company)}}{}{}{
Backend developer, infrastructure architector. Backend is on Python using Django+REST, data stored in MySQL and Amazon S3. Resources are provided by Heroku, Amazon and other IaaS/PaaS providers. My duties and contribution:
\begin{itemize}
\item \textbf{Backend:} database query/layout optimization, caching, code sanitizing (pyflakes, autopep8), tests and continuous integration
\item \textbf{Infrastructure:} migration to private cloud (to cut the costs), automated backups, monitoring, store configuration in git
\item \textbf{General duties}: architecture design, documentation, code review, supervision of interns.
\end{itemize}
%
% \begin{itemize}
% \item Backend
%   \begin{itemize}
%   \item Database query/layout optimization
%   \item Caching
%   \item Code sanitizing (pyflakes, autopep8)
%   \item Tests and continuous integration
%   \end{itemize}
% \item Infrastructure
%   \begin{itemize}
%   \item Migration from heroku and other services to ``private cloud'' (to cut the costs)
%   \item Automated backups
%   \item Monitoring
%   \end{itemize}
% \item General duties:
%   \begin{itemize}
%   \item Interns supervision
...
\section{Education}
\cventry{2010 -- 2016}{PhD (defense March 2016)}{Telecommunications}{University of Trento}{Italy}{Thesis: ``Fighting Application Interference''}{}
...
\end{description}}{}{}
\vspace{-1em}
\cvitem{Tools}{Valgrind, GDB, Qemu/KVM, perf, OProfile, OpenVpn, VCS and other tools}{}{}
...
\section{Hobbies}
\cvline{}{\small DIY electronics (microcontrollers, robot platforms and interaction with the real world).}
