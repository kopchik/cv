...
\cventry{Nov 2016 -- Now}{Python Developer}{customergauge.com}{}{}{
I work on our backend system that sends SMS and e-mails. My general duties:
\begin{itemize}
\item Keep the system healthy
\item Influence system's design
\item Promote best practices, set a good example for other teams
\item Cultivate agile principles
\item Share knowledge
\item Perform code reviews
\end{itemize}
Selected contributions:
\begin{itemize}
\item Local test environment similar to production environment (vagrant+virtualbox+docker)
\item Dockerized our Python services (deployed on dev, to be pushed on prod)
\item Graceful shutdown for our services
\item Unit tests, integration tests
\item Identified and eliminated bottlenecks found with profiler
...
% \begin{itemize}
% \item Major code refactoring to conform modern coding standards (ongoing)
% \item Reducing log pressure (ongoing)
% \item Migration to Amazon Virtual Private Cloud (VPC)
% % \item Amazon resources consolidation to cut the costs
% \item Performance monitoring and health-checks
% \end{itemize}
}

\cventry{June 2016 -- Nov 2016}{One Man Army}{AdminCup}{}{}{
...
\item react.js + material-ui
\end{itemize}
Since I found a new job and had some concerns about the future of the project I decided to terminate it.
}

\cventry{Nov 2015 -- Nov 2016}{Infrastructure Architect, Backend Developer (Python)}{\href{codesign.io}{CoDesign.IO}}{}{}{
...
\end{description}}{}{}
\vspace{-1em}
\cvitem{Tools}{Valgrind, GDB, Qemu/KVM, Docker/LXC/LXD, perf, Ansible/SaltStack, OpenVpn, VCS and other tools}{}{}
